...
- Gmail: Constant phishing campaigns
...
- **88%** of data breaches involve email
- **$6.83 million** average cost of data breach
- **121** emails per person per day (88% unwanted)
- **28%** of work time wasted on email

### Our Solution
- **0%** data retention (everything deleted)
- **0%** profiling or tracking
- **0%** third-party sharing
- **100%** transparency (open source)
- **1,350** lines of secure code
- **5 minutes** to install
- **13/13** privacy principles
...
1. **Data breaches increasing** - Every month, new breaches
2. **Privacy regulations tightening** - NZ Privacy Act, GDPR, etc.
3. **AI misuse accelerating** - Training on your private data
4. **User frustration growing** - Everyone hates email
5. **Tech monopolies dominating** - No real alternatives

**We built CAT Mail to solve this once and for all.**
...
- **[SECURITY.md](SECURITY.md)** - How we protect you
- **[PRIVACY_NOTICE.md](PRIVACY_NOTICE.md)** - Complete policy
- **[DEPLOYMENT_MASTER.md](DEPLOYMENT_MASTER.md)** - Deploy options
