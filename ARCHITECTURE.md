...
graph TB
    ...
    Tools -->|"Delete"| DeleteTool["🗑️ Delete Emails"]
    ...
    Gmail --> GmailServer["☁️ Gmail Server<br/>User's Account"]
    ...
    UserOutput -->|"Session End"| HardDelete["☠️ Hard Delete<br/>All Memory Wiped"]
...
graph TB
    ...
    GC -->|"Back to Baseline"| Complete["✅ Complete<br/>~80 MB"]
...
graph LR
    ...
    DataMin --> Barrier3["🛡️ Barrier 3<br/>No Third-Party<br/>Only: Gmail, Local"]
    
    Barrier3 --> Barrier4["🔐 Barrier 4<br/>In-Memory Only<br/>Volatile Storage"]
    
    Barrier4 --> Ops["⚙️ Execute Operations"]
    
    Ops --> Barrier5["🧹 Barrier 5<br/>Auto-Cleanup<br/>30s TTL"]
    
    Barrier5 --> Barrier6["☠️ Barrier 6<br/>Hard Delete<br/>Session End"]
    
    Barrier6 --> Done["✅ Complete<br/>No Data Retained"]
...
graph LR
    ...
    Node["⚙️ Node.js<br/>Runtime Only<br/>- V8 Engine<br/>- Event Loop<br/>- GC"]
